...
ProyectoFinalInkReserve/
├── src/
│ ├── main/
│ │ ├── java/com/salesianostriana/dam/proyectofinalinkreserve/
│ │ │ ├── config/
│ │ │ │ ├── SecurityConfig.java # Configuración de Spring Security
│ │ │ │ ├── PasswordEncoderConfig.java # Bean del encoder de contraseñas
...
│ │ │ │ ├── TatuajeController.java # CRUD tatuajes
│ │ │ │ ├── DashboardController.java # Dashboard principal
│ │ │ │ ├── UsuarioController.java # Perfil y cambio de contraseña
│ │ │ │ └── NavControllerAdvice.java # Inyecta foto y nombre en el Nav
│ │ │ ├── exception/
│ │ │ │ ├── CampoDuplicadoException.java # DNI, teléfono o email duplicado
│ │ │ │ ├── CitaSolapadaException.java # Solapamiento de citas
│ │ │ │ ├── DniInvalidoException.java # Formato de DNI inválido
│ │ │ │ └── TarifaInvalidaException.java # Tarifa o precio inválido
│ │ │ ├── model/
│ │ │ │ ├── Artista.java
│ │ │ │ ├── Cliente.java
│ │ │ │ ├── Cita.java
...
│ │ │ ├── usuario/
│ │ │ │ └── UserRol.java # Enum: ADMIN / USER
│ │ │ ├── DataSeed.java # Datos de prueba al arrancar
│ │ │ ├── UserDataSeed.java # Usuarios admin/user al arrancar
│ │ │ └── ProyectoFinalInkReserveApplication.java
│ │ └── resources/
│ │ ├── templates/
│ │ │ ├── DashboardPrincipal.html
│ │ │ ├── DashboardArtistas.html
│ │ │ ├── DashboardClientes.html
│ │ │ ├── DashboardCitas.html
│ │ │ ├── DashboardTatuajes.html
│ │ │ ├── DashboardPerfil.html
│ │ │ ├── Login.html
...
│ │ │  ├── PerfilArtista.html
│ │ │  ├── PerfilCliente.html
│ │ │  ├── FormularioArtistas.html
│ │ │  ├── FormularioClientes.html
│ │ │  ├── FormularioCitas.html
│ │ │  ├── FormularioTatuajes.html
│ │ │  ├── FichaCita.html
│ │ │  ├── FichaTatuaje.html
│ │ │  ├── ConfirmacionEliminarArtista.html
│ │ │  ├── ConfirmacionEliminarCliente.html
│ │ │  ├── ConfirmacionEliminarCita.html
│ │ │  └── ConfirmacionEliminarTatuaje.html
│ │ ├── static/
│ │ │ └── js/
│ │ │ ├── DashboardUtils.js # Utilidades generales del dashboard
│ │ │ ├── CalculoPrecioAuto.js # Cálculo automático del precio
│ │ │ ├── AutocompletarTatuaje.js # Autocompletado en formulario cita
│ │ │ └── PerfilArtistaCalendario.js # Calendario semanal del artista
│ │ └── application.properties
│ └── test/
│ └── java/.../ProyectoFinalInkReserveApplicationTests.java
└── pom.xml
