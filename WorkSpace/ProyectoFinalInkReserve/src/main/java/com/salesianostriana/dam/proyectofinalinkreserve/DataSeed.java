...
public class DataSeed {
	...
	public void run() {
		...
		Cita ci1 = Cita.builder()
				...
				.artista(a4)
				.cliente(c3)
				.fechaInicio(LocalDate.of(2026, 5, 30).atTime(16, 0))
				.fechaFinal(LocalDate.of(2026, 5, 30).atTime(18, 0))
				.duracion(2.0)
				.precioSesion(100.0)
				.build();
		...
		Cita ci2 = Cita.builder()
				...
				.artista(a3)
				.cliente(c5)
				.fechaInicio(LocalDate.of(2026, 5, 30).atTime(18, 0))
				.fechaFinal(LocalDate.of(2026, 5, 30).atTime(20, 0))
				.duracion(2.0)
				.precioSesion(100.0)
				.build();
